...
export function DocumentationPage() {
  ...
  return (
    <div className="p-6 space-y-6" data-testid="documentation-page">
      <div>
        <h1 className="text-2xl font-bold text-[#1F3A5F]">Tài Liệu Hướng Dẫn</h1>
        <p className="text-sm text-gray-600 mt-1">Hướng dẫn sử dụng hệ thống MMS cho DQTV</p>
      </div>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 bg-blue-50 rounded-lg flex items-center justify-center">
                    <Icon size={18} className="text-[#1F3A5F]" />
                  </div>
                  <div className="text-left">
                    <p className="text-sm font-semibold text-gray-900">{section.title}</p>
                    <p className="text-xs text-gray-400">{section.articles.length} bài hướng dẫn</p>
                  </div>
                </div>
